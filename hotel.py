...
from prices import price_details
class HotelManagementSystem:
    def __init__(self, root):
        ...
        ################ Title ##################
        lbl_title = Label(self.root,text="Hotel Peninsula Memories",font=("times new roman",40,"bold"),bg="black",fg="gold",bd=4,relief=RIDGE)
