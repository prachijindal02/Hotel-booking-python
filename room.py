...
class Roombooking:
    def __init__(self,root):
        ...
        combo_meal= ttk.Combobox(lblFrameLeft,textvariable=self.var_meal,font=("arial",10,"bold"),width=31,stat="readonly")
    ...
    def total(self):
        ...
        if (self.var_meal.get()=="BreakFast" and self.var_room_type.get()=="LUXUARY"):
            q1 = float(700)
            q2 = float(1300)
        ...
        elif (self.var_meal.get()=="Lunch" and self.var_room_type.get()=="LUXUARY"):
            q1 = float(700)
            q2 = float(1400)
            q3 = float(self.var_no_of_days.get())
            q4 = float(q1+q2)
        ...
        elif (self.var_meal.get()=="Dinner" and self.var_room_type.get()=="LUXUARY"):
            q1 = float(700)
            q2 = float(1500)
            q3 = float(self.var_no_of_days.get())
            q4 = float(q1+q2)
